...
public class HdlPacket {
    ...
    public static HdlPacket parse(byte[] data, int length) {
        ...
        logger.debug(
                ...
                new Object[] { packet.sourceSubnetID, packet.sourceDeviceID, packet.sourceDevice,
                        packet.sourcedeviceType, packet.command, packet.commandType, packet.targetSubnetID,
